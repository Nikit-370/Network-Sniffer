 ...
 * This uses a class called JpcapCaptor that is capable of detecting all the devices i.e. the network packet 
 * capturing devices 
 */
...
public class CaptureDialog extends JDialog implements ActionListener
{
	...
	JTextField caplenField;    //capture length field
	JRadioButton wholeCheck,headCheck,userCheck;
	JCheckBox promiscCheck;   //check the box for promicious mode
...
/*
 * This panel shows a combo box to choose the capturing device
 */
		...
		/*
		 * The above code displays a panel to ask the user to choose the maximum packet capture length
		 */
